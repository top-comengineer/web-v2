...
function	LogoConvex(props: React.SVGProps<SVGSVGElement>): ReactElement {
	return (
		<svg {...props} xmlns={'http://www.w3.org/2000/svg'} viewBox={'0 0 32 32'} width={'32'} height={'32'}>
			<defs>
				<linearGradient id={'paint0_linear'} x1={'22.8952'} y1={'5.0985'} x2={'4.0445'} y2={'34.5497'} gradientUnits={'userSpaceOnUse'} gradientTransform={'matrix(0.630801, 0, 0, 0.630801, 4.645676, 3.26105)'}>
